...
function getAll() {
    let text = "<table><tr><th>&#127468;&#127463; English</th><th>&#127467;&#127470; Finnish</th><th>&#127480;&#127466; Swedish</th></tr>";  // creates a table.
for (var i = 0; i < words.length; i++) {
    text += "<tr><td>" + words[i].english + "</td><td> " + words[i].suomi + "</td><td> " + words[i].svenska + "</td></tr>";
}
text += "</table>"
...
function search2() {
  ...
  */
  ...
  let english = [];
  let svenska = [];
  let suomiheader = "&#127467;&#127470; Finnish";
  let englishheader = "&#127468;&#127463; English";
  let svenskaheader = "&#127480;&#127466; Swedish";
